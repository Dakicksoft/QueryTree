...
namespace QueryTree.Controllers
{
  ...
  public class InvitationsController : Controller
  {
    ...
    public ActionResult Accept(int id)
    {
      ...
      List<DatabaseConnection> leave = new();
      List<DatabaseConnection> migrate = new();
      ...
      var removeOrganisationId = CurrentUser.OrganisationId;   

      CurrentUser.OrganisationId = organisation.OrganisationId;

      db.Organisations.RemoveWhere(s => s.OrganisationId == removeOrganisationId);
